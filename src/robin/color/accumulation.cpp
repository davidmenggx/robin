...
std::pair<int32_t, int32_t> Accumulation::ToPixels(float x, float y) {
  return {
    static_cast<int32_t>(x * constants::kPixelsPerUnit),
    static_cast<int32_t>(y * constants::kPixelsPerUnit)
  };
}
